...
---------------------------------------------------------------------------
DROP TABLE IF EXISTS public."CardTransactions" CASCADE;
...
create index "IX_Cards_UserId"
    on public."Cards" ("UserId");

create table public."CardTransactions"
(
    "Id"             integer generated by default as identity
        constraint "PK_CardTransactions"
            primary key,
    "Amount"         double precision         not null,
    "Date"           timestamp with time zone not null,
    "CardNumberHash" text                     not null
        constraint "FK_CardTransactions_Cards_CardNumberHash"
...
alter table public."CardTransactions"
    owner to postgres;
create index "IX_CardTransactions_CardNumberHash"
    on public."CardTransactions" ("CardNumberHash");
...
---------------------------------------------------------------------------
-- 5) Insert 40 Transactions for ANDRÉS's Card #1 ONLY
